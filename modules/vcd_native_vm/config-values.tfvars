...
vcd_template = "Swisscom RHEL 9" // vApp template name, this will be used to create the VMs from template in VCD.

vcd_storage_policy = "wms-olt-fast" // Storage Policy