...
vcd_session_token_response=$(curl --request POST 'https://sci01.test.private.cloud.swisscom.ch/oauth/tenant/aat-101-iaas-terraform-tests/token' \
...
if [ $? -eq 0 ]; then
  ...
  for i in $(seq 1 120); do
    ...
    swisscom_vm_rde_response=$(curl --request GET 'https://sci01.test.private.cloud.swisscom.ch/cloudapi/1.0.0/entities/urn:vcloud:entity:swisscom:vm:4afbd95f-86bb-4934-be31-5f00e449bd69' \
